...
//menuRight
        ...
        ADD CUSTOM<i class="fa" title="'.trans('admin.add_new').'"></i>
                           </a><a href="' . route('admin_brand.createByGsm') . '" class="btn  btn-info  btn-flat" title="Add Brand By GSM Areana" id="button_create_new">
        ADD BY GSM<i class="fa" title="'.trans('admin.add_new').'"></i>
                           </a>';
//=menuRight
 ...
 */
    ...
    public function createByGsm()
    {
        ...
        return view('admin.screen.brandGsm')
            ->with($data);
    }
