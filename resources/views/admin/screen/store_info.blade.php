...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-primary">
      ...
      <tr>
          <td>{{ trans('store_info.facebook') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="facebook" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.facebook') }}" data-value="{{ $infos->facebook }}" data-original-title="" title="">{{$infos->facebook }}</a></td>
      </tr>

      <tr>
          <td>{{ trans('store_info.instagram') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="instagram" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.instagram') }}" data-value="{{ $infos->instagram }}" data-original-title="" title="">{{$infos->instagram }}</a></td>
      </tr>

      <tr>
          <td>{{ trans('store_info.twitter') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="twitter" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.twitter') }}" data-value="{{ $infos->twitter }}" data-original-title="" title="">{{$infos->twitter }}</a></td>
      </tr>

      <tr>
          <td>{{ trans('store_info.youtube') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="youtube" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.youtube') }}" data-value="{{ $infos->youtube }}" data-original-title="" title="">{{$infos->youtube }}</a></td>
      </tr>

      <tr>
          <td>{{ trans('store_info.reddit') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="reddit" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.reddit') }}" data-value="{{ $infos->reddit }}" data-original-title="" title="">{{$infos->reddit }}</a></td>
      </tr>

      <tr>
          <td>{{ trans('store_info.tumblr') }}</td>
          <td><a href="#" class="fied-required editable editable-click" data-name="tumblr" data-type="text" data-pk="" data-source="" data-url="{{ route('admin_store_info.update') }}" data-title="{{ trans('store_info.tumblr') }}" data-value="{{ $infos->tumblr }}" data-original-title="" title="">{{$infos->tumblr }}</a></td>
      </tr>
