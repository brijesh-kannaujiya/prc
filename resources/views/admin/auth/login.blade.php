        ...
        <form action="{{ route('admin.login') }}" method="post">
          ...
          <div class="col-md-12 form-group has-feedback {!! !$errors->has('username') ?: 'has-error' !!}">
            <div class="wrap-input100 validate-input form-group ">
              <input class="input100 form-control" type="text" placeholder="{{ trans('admin.username') }}" name="username" value="{{ old('username') }}">
          ...
          <div class="col-md-12 form-group has-feedback {!! !$errors->has('password') ?: 'has-error' !!}">
            <div class="wrap-input100 validate-input form-group ">
              <input class="input100 form-control" type="password" placeholder="{{ trans('admin.password') }}" name="password">
              <span class="focus-input100"></span>
              <span class="symbol-input100">
