					...
					<div class="container">
						<div class="page-title-inner">
							<div class="page-title-content clearfix">
								<h1 class="page-title ft-heading-b">B2B Phone Repair</h1>   </div>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="content" class="site-content">
				<div class="content-inner" >
					...
					<div class="container content-container">
						<div class="row">
							<div id="primary" class="content-area col-12 col-md-12 col-lg-12 col-xs-12 col-sm-12">
									...
									<div class="post-type-inner">
										<div class="post-type-content">
											{{--<div class="vc_row wpb_row vc_row-fluid">
												...
												<div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12 col-12 col-md-12 col-lg-12 col-xs-12 col-sm-12">
													<div class="vc_column-inner">
														<div class="wpb_wrapper">
															<div id="cms-heading"
																...
																<h3 class="cms-heading-tag  " style="margin-bottom:20px;color:#083260;font-size:54px;letter-spacing:-.016em;text-transform:none;font-weight:400;font-style:normal;display:inline-block; " >
																	{!! sc_html_render(sc_link_content('b2b-repair-heading')) !!}</h3>

															</div>
															{!! sc_html_render(sc_link_content('b2b-repair-content')) !!}
																				...
																				<div class="service-options">
																					<div class="repair-carousel owl-carousel" data-item-xs=1 data-item-sm=2 data-item-md=3 data-item-lg=3 data-margin=30 data-loop=true data-autoplay=false data-autoplaytimeout=5000 data-smartspeed=250 data-center=false data-arrows=true data-bullets=true data-stagepadding=0 data-rtl=false >
																						@foreach($prodrepairs as $repair)
																							<div class="repair-item">
																								<div class="image-product-repair" style="margin: 0px 40px;">
