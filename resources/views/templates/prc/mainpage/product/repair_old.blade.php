...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row" style=" border-radius: 10px; box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.11);">
            <div class="col-sm-12" style="background: #00303e;"><h3 style="color: #ffe303;margin: 0px auto;text-align: center;">{{  $repair->title }}</h3></div>
            <div class="col-md-6" style="text-align: center;height: auto;padding: 5px">
                <img src="{{ $repair->image  }}" id="product-image" style="max-width: 450px;max-height: 450px;"/>
            </div>
            <div class="col-md-6">
        ...
        @unless(empty($productrepairprice->price_range))
            <hr>
            <div class="col-sm-12" style="background: #fad33c;"><p style="color: #00303e">Repair Price : {{  $productrepairprice->price_range }}</p></div>
        @endunless
