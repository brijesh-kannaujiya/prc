                                                ...
                                                <div class="wpb_wrapper">
                                                    <div id="cms-heading"
                                                        ...
                                                        <h3 class="cms-heading-tag  "
                                                            ...
                                                            Choose Your {{$cat->title}} Model</h3>
                                                                            ...
                                                                            @foreach($productList as $product)
                                                                                <div class="repair-item col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6">
                                                                                    <div class="image-item">
                                                                                        <a href="{{ route('product.product', [$product->alias]) }}">
                                                                                            <img src="{{ $product->image }}" alt="{{ $product->name }}">
                                                                                        </a>
                                                                                    </div>
                                                                                    <h3>
                                                                                        <a href="{{ route('product.product', [$product->alias]) }}">{{ $product->name }}</a>
                                                                                    </h3>
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
