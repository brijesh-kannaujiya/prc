...
<head>
    ...
    <link rel="stylesheet" href="{{ asset($templateFile.'/css/main.css')}}?v={{ filemtime(public_path($templateFile.'/css/main.css')) }}" />
    <link rel="stylesheet" href="{{ asset($templateFile.'/css/main-rtl.css')}}?v={{ filemtime(public_path($templateFile.'/css/main-rtl.css')) }}" />
    @stack('styles')
