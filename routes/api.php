...
// Route::get('productslist/{brand_id}/{category_id}', 'ShopFront@getProductByBrandAndCategory');
Route::get('productslist', 'ShopFront@getProductByBrandAndCategory');

Route::get('brands','ShopFront@getBrand');
