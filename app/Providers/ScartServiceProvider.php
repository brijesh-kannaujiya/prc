...
class ScartServiceProvider extends ServiceProvider
{
    ...
    public function bootScart()
    {
            ...
            view()->share('layoutsUrlFooter', sc_link_footer());
            view()->share('sc_faq_home', sc_faq_home());
            view()->share('sc_testimonial', sc_testimonial());
            view()->share('templatePath', 'templates.' . sc_store('template'));
            view()->share('templateFile', 'templates/' . sc_store('template'));
            view()->share('adminStore',prc_social_media());
            view()->share('adminHome',prc_home());
            //variable model
