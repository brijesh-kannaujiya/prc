 ...
 */
if (!function_exists('sc_link_footer')) {
    function sc_link_footer()
    {
...
if (!function_exists('sc_link')) {
    function sc_link()
    {
        ...
        return ShopLink::getList($arrOpt=['group'=>'menu','status'=>1],['sortBy'=>'sort'],[]);
    }
}
...
//Get all language
if (!function_exists('sc_link_content')) {
    function sc_link_content($keyword)
    {
        $content = \App\Models\ShopLinkContent::getByKeyword($keyword);
        return $content;
    }
}

if (!function_exists('sc_faq_home')) {
    function sc_faq_home()
    {
        $faqs = \App\Models\ShopFaq::getListForHome();
        return $faqs;
    }
}

if (!function_exists('sc_testimonial')) {
    function sc_testimonial()
    {
        $testimonial = \App\Models\ShopTestimonial::getList();
        return $testimonial;
    }
}
...
if (!function_exists('prc_social_media')) {
    function prc_social_media()
    {
        return AdminStore::getData();
    }
}

if (!function_exists('prc_home')) {
    function prc_home()
    {
        return \App\Models\AdminHome::getData();
    }
}