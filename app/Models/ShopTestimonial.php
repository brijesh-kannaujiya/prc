<?php
#app/Models/ShopTestimonial.php
...
class ShopTestimonial extends Model
{
    ...
    public $table = SC_DB_PREFIX.'shop_testimonial';
    protected $guarded = [];
    ...
    public static function getListForHome()
    {
        if (self::$getList == null) {
            self::$getList = self::get()->where('status',1)->keyBy('id');
        }
        return self::$getList;
    }
