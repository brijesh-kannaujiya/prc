...
{
    public $languages,$productSortBy,$productSortType;
    ...
    public function index()
    {
        ...
        if($select_filter){
            ...
            $obj = (new ShopCategory())->where('brand_id',$brand->id);
            $obj = $obj
        ...
        foreach ($dataTmp as $key => $row) {
            $brandName = "";
            if(isset($row['brand_id']->name)){
                $brandName = (ShopBrand::getOne($row['brand_id'])->name );
            }
            ...
            $dataTr[] = [
                ...
                //'brand' => $row['brand_id'] ? ($row->getBrand($row['brand_id'])->name ) : '',
                'brand' => $row['brand_id'] ? $brandName : '',
                // 'brand' => $row['brand_id'] ? (ShopBrand::getOne($row['brand_id'])->name ) : '',
 ...
 */
    public function create()
    {
        ...
        $data = [
            ...
            'productSortBy' =>$this->productSortBy,
            'productSortType'   =>$this->productSortType,
 ...
 */
    public function postCreate()
    {
        ...
        $dataInsert = [
            ...
            'product_sort_type' => $data['product_sort_type'],
