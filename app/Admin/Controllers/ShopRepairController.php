        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataTr[] = [
                ...
                'action' => '
                    ...
                    <a href="' . route('admin_repair.copy', ['id' => $row['id']]) . '"><span title="' . trans('repair.admin.copy') . '" type="button" class="btn btn-flat btn-info"><i class="fa fa-copy"></i></span></a>
